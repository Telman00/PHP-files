    ...
    <div class="container">
        <form method="post" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="email" value="<?php echo htmlspecialchars($_POST['email'] ?? '', ENT_QUOTES); ?>" name="email" aria-describedby="email">
                <?php if (isset($errors['email'])): ?>
                    <?php foreach ($errors['email'] as $error): ?>
                        <small id="emailHelp" class="form-text text-muted"><?php echo htmlspecialchars($error, ENT_QUOTES); ?></small>
                    <?php endforeach; ?>
                <?php endif; ?>
            </div>
            <div class="form-group">
